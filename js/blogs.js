...
const article3 = {
  ...
  body: `
  <p>
  Someone divine, perfect and special. Her name is despondency and she is charming. Her allure is ravishing, you find it unyielding to resist. She stifles each and every existence around you. You want to fight, to be unshackled of her heavy reign. However, she extends her hand out to you. She has you trapped. Confined within her head space, the aura she exudes  strangulates you.
  </p>
  <p>
...
const article4 = {
  ...
  body:`
  <p>
  It is beautiful today. The silence and peace. This is what they call inner peace I think. It's a Saturday it's pretty hot outside but I actually feel cool.
...
const article5 = {
  ...
  body: `
  <p>
  State of the average teenager is on an endless downward trajectory. These days, no taking heart. Gloom and despondency lingers, so prevelant and perhaps getting worse you can almost reach out and touch it. Terms such as depression are common house hold names. An abstract conviction selling as fast as hot cakes in demand in each and every corner store.
  </p>
  <p>
